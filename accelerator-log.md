...
```json
{
  "projectName" : "guy-java-example-web-app",
...
┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [tanzu-java-web-app->guy-java-example-web...(truncated)]
...
┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [: tanzu-java-web-app->: guy-java-example-w...(truncated)]
